...
/**
 * TextEditor component for the web forum, used for creating a new review
 ...
 */
const ReplyTextEditor = ({ id, reviewId }: { id: number, reviewId: number }) => {
  ...
  const postData = (data: any) => {
    ...
    setIsLoading(true)
    fetch(API_URL + `/review/` + reviewId.toString(), {
      method: "POST",
      headers: {

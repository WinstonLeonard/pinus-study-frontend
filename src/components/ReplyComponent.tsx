...
import { Comment, CommentInitialState } from "../features/comments/commentSlice";
 ...
 */
const ReplyComponent = ({ commentId }: { commentId: number }) => {
    ...
    const parseDuration = (timestamp: string): string => {
        ...
        const durationInMilliseconds =
            Date.now().valueOf() - datePosted.valueOf();
    ...
    return (
        <ThreadContainerDiv>
            ...
            <VerticalCenterAlignLayout>
                ...
                <ReplyText onClick={() => openReplyInputField()}>
                    Reply
                </ReplyText>
            </VerticalCenterAlignLayout>
            <ViewRepliesLink>
